...
export const getOtpTemplate = (otp, ttlMinutes) => {
  return `
    <div style="
    ...
    ">
      <div style="text-align: center; margin-bottom: 20px;">
        <h2 style="color: #4A3AFF; margin: 0;">BookMe</h2>
      </div>
      ...
      <p style="font-size: 16px; color: #333;">
        Welcome to <strong>BookMe</strong> 👋  
      ...
      <p style="font-size: 14px; color: #888; text-align: center;">
        Happy Learning 🎉<br/>
        <strong>Team BookMe</strong>
      </p>
    </div>
  `;
}

export const getWelcomeTemplate = (firstName) => {
  return `
    <div style="
      font-family: Arial, sans-serif; 
      max-width: 420px; 
...
export const getTicketConfirmationTemplate = (ticketData) => {
